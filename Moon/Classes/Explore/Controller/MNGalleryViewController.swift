...
class MNGalleryViewController: UITableViewController {
  
  var galleryEntityList =  MNGalleryEntityList()
  ...
  func initData() {
    galleryEntityList.loadGalleryData()
  }
